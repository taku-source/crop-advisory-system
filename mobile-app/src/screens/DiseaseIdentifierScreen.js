...
const s = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 12, fontWeight: '700', color: '#ffffff', textTransform: 'uppercase', letterSpacing: 0.5, marginTop: 16, marginBottom: 10 },
  ...
  symptomChipText: { fontSize: 12, color: '#ffffff', fontWeight: '600' },
  ...
  matchInfo: { fontSize: 12, color: '#ffffff', marginBottom: 10, fontWeight: '600' },
  ...
  managementText: { fontSize: 12, color: '#ffffff', marginBottom: 4, lineHeight: 18 },
