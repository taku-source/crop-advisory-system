...
const s = StyleSheet.create({
  ...
  recordCat: { fontSize: 12, fontWeight: '700', color: '#ffffff', flex: 1, textTransform: 'uppercase', letterSpacing: 0.3 },
  recordDate: { fontSize: 11, color: '#aaa' },
  recordField: { fontSize: 13, color: '#333', marginTop: 2 },
  fieldKey: { fontWeight: '700', color: '#ffffff' },
  ...
  label: { fontSize: 12, fontWeight: '700', color: '#ffffff', marginBottom: 5, marginTop: 12, textTransform: 'uppercase', letterSpacing: 0.3 },
